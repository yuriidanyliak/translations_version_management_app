...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { json_spec: @tool.json_spec, language: @tool.language, name: @tool.name } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { json_spec: @tool.json_spec, language: @tool.language, name: @tool.name } }
